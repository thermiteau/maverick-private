...
digraph failure {
    ...
    "Apply systematic-debugging skill" [shape=box];
    ...
    "Attempt count" -> "Apply systematic-debugging skill" [label="> 2"];
    "Apply systematic-debugging skill" -> "Still stuck?";
...
|---|---|---|
| Step fails after 2 fix attempts | Apply systematic-debugging skill. If still stuck, ask user for help. | Ask user for help immediately. |
